...
4. Generate a presentation from the statistics and save it to [slides/index.html](slides/index.html)
...
├── slides/
│   ├── index.html              # Presentation generated from the statistics
...
- `generate_slides.py`: Generates an HTML presentation (`slides/index.html`) using the statistics from `stats.json` and a Jinja2 template (`slides/template.html`).